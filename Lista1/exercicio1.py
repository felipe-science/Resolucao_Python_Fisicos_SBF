...
plt.scatter(t,y,color='black', label='Dados')
plt.plot(time,y1_data,color='blue', label='Sem resistência')
plt.plot(time,y2_data,color='red', label='Com resistência')
plt.title("Queda Livre", fontsize='15')
...
plt.title("Velocidade média",fontsize='15')
plt.xlabel("Tempo (s)", fontsize='15')
